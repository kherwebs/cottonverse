          ...
          <Column className="items-center w-[100%]">
            <Row className="bg-white_A700 items-center justify-end lg:p-[14px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] w-[100%]">
              ...
              <Img
                ...
                alt="car"
              />
              <Button className="font-medium lg:ml-[19px] xl:ml-[22px] 2xl:ml-[25px] 3xl:ml-[30px] 3xl:mr-[108px] lg:mr-[70px] xl:mr-[80px] 2xl:mr-[90px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-center w-[6%]">
                Login
              </Button>
            </Row>
